...
adapter.onTurnError = async (turnContext, error) => {
    ...
    await turnContext.sendActivity(`[AdapterException]`);
    // Load state
...
const lgEntityAccessor = userState.createProperty(LG_ENTITIES_PROPERTY);
...
let bot;
try {
    bot = new CafeBot(conversationState, userState, botConfig, lgEntityAccessor);
} catch (err) {
