...
class CafeBot {
     ...
     * @param {StatePropertyAccessor} lgEntityAccessor LG entity property accessor
     *
     */
    constructor(conversationState, userState, botConfig, lgEntityAccessor) {
        ...
        this.dialogs.add(new MainDispatcher(botConfig, this.onTurnAccessor, conversationState, userState, lgEntityAccessor));
    ...
    async detectIntentAndEntitiesFromCardInput(turnContext) {
        ...
        if (turnContext.activity.attachments && turnContext.activity.attachments.length !== 0) {
            await turnContext.sendActivity(`[AttachmentUpload]`);
            return undefined;
        }
        ...
        if (turnContext.activity.membersAdded.length !== 0) {
            ...
            for (var idx in turnContext.activity.membersAdded) {
                ...
                if (turnContext.activity.membersAdded[idx].id !== turnContext.activity.recipient.id) {
                    // Welcome user.
                    await turnContext.sendActivity(`[BotIntro]`);
                    await turnContext.sendActivity(`[IntroText]`);
