...
import { AdaptiveDialog, OnUnknownIntent, SendActivity, SetProperty, SwitchCondition, InitProperty, EditArray, ArrayChangeType, TextInput, TraceActivity } from 'botbuilder-dialogs-adaptive';
