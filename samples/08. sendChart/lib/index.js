...
dialogs.addRule(new botbuilder_rules_1.DefaultRule([
    new botbuilder_rules_1.SetProperty(`conversation.chartData.World = 10`),
    new botbuilder_rules_1.SetProperty(`conversation.chartData.Hello = 15`),
    new botbuilder_rules_1.SendChart(botbuilder_rules_1.ChartType.pie, 'conversation.chartData')
]));
