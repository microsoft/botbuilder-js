...
import { PlanningDialog, FallbackRule, SendActivity, IfProperty, WelcomeRule, TextInput, RegExpRecognizer, DoStepsRule, WaitForInput } from 'botbuilder-planning';
...
bot.addRule(new DoStepsRule('JokeIntent', [
