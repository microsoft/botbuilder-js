...
class AddToDo extends botbuilder_dialogs_adaptive_1.AdaptiveDialog {
    constructor() {
        super('AddToDo', [
            ...
            new botbuilder_dialogs_adaptive_1.EditArray(botbuilder_dialogs_adaptive_1.ArrayChangeType.push, 'dialog.todos', '$title'),
            ...
            new botbuilder_dialogs_adaptive_1.IfCondition(`dialog.tips.showToDos != true`, [
                new botbuilder_dialogs_adaptive_1.SendActivity(`To view your todos just ask me to "show my todos".`),
                new botbuilder_dialogs_adaptive_1.SetProperty('dialog.tips.showToDos', 'true')
            ])
        ]);
