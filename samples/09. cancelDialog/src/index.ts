...
import { PlanningDialog, FallbackRule, SendActivity, IfProperty, WelcomeRule, TextInput, RegExpRecognizer, ReplacePlanRule, WaitForInput, SequenceDialog, CallDialog, DoStepsRule, CancelDialog, EventRule } from 'botbuilder-planning';
...
tellJokeDialog.recognizer = new RegExpRecognizer().addIntent('CancelIntent', /^(?:cancel|never mind)/i);
tellJokeDialog.addRule(new DoStepsRule('CancelIntent', [
    new CancelDialog()
]));
