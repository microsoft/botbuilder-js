...
tellJokeDialog.recognizer = new botbuilder_planning_1.RegExpRecognizer().addIntent('CancelIntent', /^(?:cancel|never mind)/i);
tellJokeDialog.addRule(new botbuilder_planning_1.DoStepsRule('CancelIntent', [
