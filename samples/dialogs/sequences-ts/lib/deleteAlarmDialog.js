...
class DeleteAlarmDialog extends botbuilder_dialogs_1.DialogContainer {
    constructor(userState) {
        super('deleteAlarm');
        this.dialogs.add('deleteAlarm', new botbuilder_dialogs_1.Sequence([
            new botbuilder_dialogs_1.CodeStep((dc, step) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (user.alarms.length > 1) {
                    return yield dc.begin('deleteAlarmMulti');
                }
                else if (user.alarms.length === 1) {
                    return yield dc.begin('deleteAlarmSingle');
                }
                else {
        ...
        this.dialogs.add('deleteAlarmMulti', new botbuilder_dialogs_1.Sequence([
            new botbuilder_dialogs_1.CodeStep('choice', (dc, step) => __awaiter(this, void 0, void 0, function* () {
                ...
                return yield dc.prompt('choicePrompt', prompt, choices);
            })),
            new botbuilder_dialogs_1.CodeStep((dc, step) => __awaiter(this, void 0, void 0, function* () {
        ...
        this.dialogs.add('deleteAlarmSingle', new botbuilder_dialogs_1.Sequence([
            new botbuilder_dialogs_1.CodeStep('confirm', (dc, step) => __awaiter(this, void 0, void 0, function* () {
                const user = userState.get(dc.context);
                const alarm = user.alarms[0];
                return yield dc.prompt('confirmPrompt', `Are you sure you want to delete the "${alarm.title}" alarm?`);
            })),
            new botbuilder_dialogs_1.CodeStep((dc, step) => __awaiter(this, void 0, void 0, function* () {
