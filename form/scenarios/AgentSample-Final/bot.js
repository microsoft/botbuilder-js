...
*/
export function havemoreturns_onRun(context) {
...
* @param {IConversationContext} context
*/
export function turnprep_onRun(context) {
...
* @param {IConversationContext} context
*/
export function AskForGuessTemplate_onRun(context) {
...
* @param {IConversationContext} context
*/
export function Turnprompt_repromptWhen(context) {
...
* @param {IConversationContext} context
*/
export function outcome_onRun(context) {
    if(context.taskEntities.hint) {
...
* @param {IConversationContext} context
*/
export function Validateguess_onRun(context) {
...
* @param {IConversationContext} context
*/
export function GuessFeedbackTemplate_onRun(context) {
...
* @param {IConversationContext} context
*/
export function ScoreTemplate_onRun(context) {
...
* @param {IConversationContext} context
*/
export function Gameintro_beforeResponse(context) {
...
* @param {IConversationContext} context
*/
export function Turnprompt_beforeResponse(context) {
...
* @param {IConversationContext} context
*/
export function Guessreadout_beforeResponse(context) {
...
* @param {IConversationContext} context
*/
export function Turnprompt_promptWhen(context) {
...
* @param {IConversationContext} context
*/
export function Howdidtheguessgo_onRun(context) {
    if(context.taskEntities.guessOutcome[0].value == 0) {
        return "0";
    } else if(context.taskEntities.guessOutcome[0].value == 1) {
        return "1";
...
* @param {IConversationContext} context
*/
export function Playhint_promptWhen(context) {
    delete context.taskEntities["hint"];
    return true;
}
...
* @param {IConversationContext} context
*/
export function cancelandscore_onRun(context) {
    // score and prep response
    console.log("Final score::::" + context.taskEntities.score[0].value);
    context.addTaskEntity("finalScoreReadout", FinalScoreReadOut[context.taskEntities.score[0].value].value); 
}
...
* @param {IConversationContext} context
*/
export function Playhint_beforeResponse(context) {
...
* @param {IConversationContext} context
*/
export function Echotask_if_onRun(context) {
    var activity = context.request;
...
* @param {IConversationContext} context
*/
export function default_onRun(context) {
