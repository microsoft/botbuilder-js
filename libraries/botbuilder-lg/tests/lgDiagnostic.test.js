...
describe(`LGExceptionTest`, function() {
    ...
    it('TestRunTimeErrors', function() {
        ...
        assert.strictEqual(isSuccessful, false);
        //assert.strictEqual(errorMessage, `Error: 'dialog.abc' evaluated to null. [template1]  Error occurred when evaluating '-I want \${dialog.abc}'. [conditionalTemplate1] Condition '\${dialog}':  Error occurred when evaluating '-I want \${template1()}'`);
