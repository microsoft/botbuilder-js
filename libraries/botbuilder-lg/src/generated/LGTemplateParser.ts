...
export class LGTemplateParser extends Parser {
    ...
    public get grammarFileName(): string {
        return 'LGTemplateParser.g4';
    }

    // @Override
    public get ruleNames(): string[] {
        return LGTemplateParser.ruleNames;
    }

    // @Override
    public get serializedATN(): string {
        return LGTemplateParser._serializedATN;
    }
        ...
        try {
            this.enterOuterAlt(_localctx, 1);
            {
                ...
                if (
                    ((_la - 26) & ~0x1f) === 0 &&
                    ((1 << (_la - 26)) &
                        ((1 << (LGTemplateParser.STRUCTURED_NEWLINE - 26)) |
                            (1 << (LGTemplateParser.STRUCTURE_IDENTIFIER - 26)) |
                            (1 << (LGTemplateParser.STRUCTURE_EQUALS - 26)) |
                            (1 << (LGTemplateParser.STRUCTURE_OR_MARK - 26)) |
                            (1 << (LGTemplateParser.ESCAPE_CHARACTER_IN_STRUCTURE_BODY - 26)) |
                            (1 << (LGTemplateParser.EXPRESSION_IN_STRUCTURE_BODY - 26)) |
                            (1 << (LGTemplateParser.TEXT_IN_STRUCTURE_BODY - 26)))) !==
                        0
                ) {
                    {
                        this.state = 59;
                                        ...
                                        {
                                            {
                                                ...
                                                _la = this._input.LA(1);
                                                if (
                                                    _la === LGTemplateParser.STRUCTURE_IDENTIFIER ||
                                                    _la === LGTemplateParser.EXPRESSION_IN_STRUCTURE_BODY
                                                ) {
                                                    {
                                                        this.state = 54;
                    ...
                    {
                        {
                            ...
                            if (
                                !(
                                    _la === LGTemplateParser.STRUCTURE_NAME ||
                                    _la === LGTemplateParser.TEXT_IN_STRUCTURE_NAME
                                )
                            ) {
        ...
        try {
            this.enterOuterAlt(_localctx, 1);
            {
                ...
                do {
                    ...
                    ((_la - 31) & ~0x1f) === 0 &&
                    ((1 << (_la - 31)) &
                        ((1 << (LGTemplateParser.ESCAPE_CHARACTER_IN_STRUCTURE_BODY - 31)) |
                            (1 << (LGTemplateParser.EXPRESSION_IN_STRUCTURE_BODY - 31)) |
                            (1 << (LGTemplateParser.TEXT_IN_STRUCTURE_BODY - 31)))) !==
                        0
                );
            }
        } catch (re) {
        ...
        try {
            this.enterOuterAlt(_localctx, 1);
            {
                ...
                while (
                    (_la & ~0x1f) === 0 &&
                    ((1 << _la) &
                        ((1 << LGTemplateParser.ESCAPE_CHARACTER) |
                            (1 << LGTemplateParser.EXPRESSION) |
                            (1 << LGTemplateParser.TEXT))) !==
                        0
                ) {
                    {
                        this.state = 128;
            ...
            this.enterOuterAlt(_localctx, 1);
            {
                ...
                if (
                    !(
                        (_la & ~0x1f) === 0 &&
                        ((1 << _la) &
                            ((1 << LGTemplateParser.IF) |
                                (1 << LGTemplateParser.ELSEIF) |
                                (1 << LGTemplateParser.ELSE))) !==
                            0
                    )
                ) {
                    this._errHandler.recoverInline(this);
            ...
            this.enterOuterAlt(_localctx, 1);
            {
                ...
                if (
                    !(
                        (_la & ~0x1f) === 0 &&
                        ((1 << _la) &
                            ((1 << LGTemplateParser.SWITCH) |
                                (1 << LGTemplateParser.CASE) |
                                (1 << LGTemplateParser.DEFAULT))) !==
                            0
                    )
                ) {
                    this._errHandler.recoverInline(this);
    ...
    public static get _ATN(): ATN {
        if (!LGTemplateParser.__ATN) {
            LGTemplateParser.__ATN = new ATNDeserializer().deserialize(
                Utils.toCharArray(LGTemplateParser._serializedATN)
            );
        }
...
export class TemplateContext extends ParserRuleContext {
    ...
    public EOF(): TerminalNode {
        return this.getToken(LGTemplateParser.EOF, 0);
    }
    ...
    public get ruleIndex(): number {
        return LGTemplateParser.RULE_template;
    }
    // @Override
...
export class BodyContext extends ParserRuleContext {
    ...
    // @Override
    public get ruleIndex(): number {
        return LGTemplateParser.RULE_body;
    }
...
export class StructuredTemplateBodyContext extends ParserRuleContext {
    ...
    public structuredBodyContentLine(
        i?: number
    ): StructuredBodyContentLineContext | StructuredBodyContentLineContext[] {
        if (i === undefined) {
    ...
    // @Override
    public get ruleIndex(): number {
        return LGTemplateParser.RULE_structuredTemplateBody;
    }
    // @Override
    public enterRule(listener: LGTemplateParserListener): void {
...
export class StructuredBodyNameLineContext extends ParserRuleContext {
    public LEFT_SQUARE_BRACKET(): TerminalNode {
        return this.getToken(LGTemplateParser.LEFT_SQUARE_BRACKET, 0);
    }
    public STRUCTURE_NAME(): TerminalNode | undefined {
        return this.tryGetToken(LGTemplateParser.STRUCTURE_NAME, 0);
    }
    ...
    // @Override
    public get ruleIndex(): number {
        return LGTemplateParser.RULE_structuredBodyNameLine;
    }
    // @Override
    public enterRule(listener: LGTemplateParserListener): void {
...
export class ErrorStructuredNameContext extends ParserRuleContext {
    ...
    // @Override
    public get ruleIndex(): number {
        return LGTemplateParser.RULE_errorStructuredName;
    }
    // @Override
    public enterRule(listener: LGTemplateParserListener): void {
...
export class StructuredBodyContentLineContext extends ParserRuleContext {
    ...
    // @Override
    public get ruleIndex(): number {
        return LGTemplateParser.RULE_structuredBodyContentLine;
    }
    // @Override
    public enterRule(listener: LGTemplateParserListener): void {
...
export class ErrorStructureLineContext extends ParserRuleContext {
    ...
    // @Override
    public get ruleIndex(): number {
        return LGTemplateParser.RULE_errorStructureLine;
    }
    // @Override
    public enterRule(listener: LGTemplateParserListener): void {
...
export class KeyValueStructureLineContext extends ParserRuleContext {
    public STRUCTURE_IDENTIFIER(): TerminalNode {
        return this.getToken(LGTemplateParser.STRUCTURE_IDENTIFIER, 0);
    }
    public STRUCTURE_EQUALS(): TerminalNode {
        return this.getToken(LGTemplateParser.STRUCTURE_EQUALS, 0);
    }
    public keyValueStructureValue(): KeyValueStructureValueContext[];
    ...
    // @Override
    public get ruleIndex(): number {
        return LGTemplateParser.RULE_keyValueStructureLine;
    }
    // @Override
    public enterRule(listener: LGTemplateParserListener): void {
...
export class KeyValueStructureValueContext extends ParserRuleContext {
    ...
    // @Override
    public get ruleIndex(): number {
        return LGTemplateParser.RULE_keyValueStructureValue;
    }
    // @Override
    public enterRule(listener: LGTemplateParserListener): void {
...
export class StructuredBodyEndLineContext extends ParserRuleContext {
    public STRUCTURED_BODY_END(): TerminalNode {
        return this.getToken(LGTemplateParser.STRUCTURED_BODY_END, 0);
    }
    constructor(parent: ParserRuleContext | undefined, invokingState: number) {
        super(parent, invokingState);
    }
    // @Override
    public get ruleIndex(): number {
        return LGTemplateParser.RULE_structuredBodyEndLine;
    }
    // @Override
    public enterRule(listener: LGTemplateParserListener): void {
...
export class NormalTemplateBodyContext extends ParserRuleContext {
    ...
    // @Override
    public get ruleIndex(): number {
        return LGTemplateParser.RULE_normalTemplateBody;
    }
    // @Override
    public enterRule(listener: LGTemplateParserListener): void {
...
export class TemplateStringContext extends ParserRuleContext {
    ...
    // @Override
    public get ruleIndex(): number {
        return LGTemplateParser.RULE_templateString;
    }
    // @Override
    public enterRule(listener: LGTemplateParserListener): void {
...
export class NormalTemplateStringContext extends ParserRuleContext {
    public DASH(): TerminalNode {
        return this.getToken(LGTemplateParser.DASH, 0);
    }
    public MULTILINE_PREFIX(): TerminalNode | undefined {
        return this.tryGetToken(LGTemplateParser.MULTILINE_PREFIX, 0);
    }
    ...
    public MULTILINE_SUFFIX(): TerminalNode | undefined {
        return this.tryGetToken(LGTemplateParser.MULTILINE_SUFFIX, 0);
    }
    constructor(parent: ParserRuleContext | undefined, invokingState: number) {
        super(parent, invokingState);
    }
    // @Override
    public get ruleIndex(): number {
        return LGTemplateParser.RULE_normalTemplateString;
    }
    // @Override
    public enterRule(listener: LGTemplateParserListener): void {
...
export class ErrorTemplateStringContext extends ParserRuleContext {
    ...
    // @Override
    public get ruleIndex(): number {
        return LGTemplateParser.RULE_errorTemplateString;
    }
    // @Override
    public enterRule(listener: LGTemplateParserListener): void {
...
export class IfElseTemplateBodyContext extends ParserRuleContext {
    ...
    // @Override
    public get ruleIndex(): number {
        return LGTemplateParser.RULE_ifElseTemplateBody;
    }
    // @Override
    public enterRule(listener: LGTemplateParserListener): void {
...
export class IfConditionRuleContext extends ParserRuleContext {
    ...
    // @Override
    public get ruleIndex(): number {
        return LGTemplateParser.RULE_ifConditionRule;
    }
    // @Override
    public enterRule(listener: LGTemplateParserListener): void {
...
export class IfConditionContext extends ParserRuleContext {
    ...
    public IF(): TerminalNode | undefined {
        return this.tryGetToken(LGTemplateParser.IF, 0);
    }
    public ELSE(): TerminalNode | undefined {
        return this.tryGetToken(LGTemplateParser.ELSE, 0);
    }
    public ELSEIF(): TerminalNode | undefined {
        return this.tryGetToken(LGTemplateParser.ELSEIF, 0);
    }
    ...
    // @Override
    public get ruleIndex(): number {
        return LGTemplateParser.RULE_ifCondition;
    }
    // @Override
    public enterRule(listener: LGTemplateParserListener): void {
...
export class SwitchCaseTemplateBodyContext extends ParserRuleContext {
    ...
    // @Override
    public get ruleIndex(): number {
        return LGTemplateParser.RULE_switchCaseTemplateBody;
    }
    // @Override
    public enterRule(listener: LGTemplateParserListener): void {
...
export class SwitchCaseRuleContext extends ParserRuleContext {
    ...
    // @Override
    public get ruleIndex(): number {
        return LGTemplateParser.RULE_switchCaseRule;
    }
    // @Override
    public enterRule(listener: LGTemplateParserListener): void {
...
export class SwitchCaseStatContext extends ParserRuleContext {
    ...
    public SWITCH(): TerminalNode | undefined {
        return this.tryGetToken(LGTemplateParser.SWITCH, 0);
    }
    public CASE(): TerminalNode | undefined {
        return this.tryGetToken(LGTemplateParser.CASE, 0);
    }
    public DEFAULT(): TerminalNode | undefined {
        return this.tryGetToken(LGTemplateParser.DEFAULT, 0);
    }
    public WS(): TerminalNode[];
    public WS(i: number): TerminalNode;
    public WS(i?: number): TerminalNode | TerminalNode[] {
    ...
    // @Override
    public get ruleIndex(): number {
        return LGTemplateParser.RULE_switchCaseStat;
    }
    // @Override
    public enterRule(listener: LGTemplateParserListener): void {
...
export class ExpressionContext extends ParserRuleContext {
    public EXPRESSION(): TerminalNode {
        return this.getToken(LGTemplateParser.EXPRESSION, 0);
    }
    constructor(parent: ParserRuleContext | undefined, invokingState: number) {
        super(parent, invokingState);
    }
    // @Override
    public get ruleIndex(): number {
        return LGTemplateParser.RULE_expression;
    }
    // @Override
    public enterRule(listener: LGTemplateParserListener): void {
...
export class ExpressionInStructureContext extends ParserRuleContext {
    public EXPRESSION_IN_STRUCTURE_BODY(): TerminalNode {
        return this.getToken(LGTemplateParser.EXPRESSION_IN_STRUCTURE_BODY, 0);
    }
    constructor(parent: ParserRuleContext | undefined, invokingState: number) {
        super(parent, invokingState);
    }
    // @Override
    public get ruleIndex(): number {
        return LGTemplateParser.RULE_expressionInStructure;
    }
    // @Override
    public enterRule(listener: LGTemplateParserListener): void {
