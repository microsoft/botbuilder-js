...
export class LGFileParser extends Parser {
	...
	public structuredTemplateBody(): StructuredTemplateBodyContext {
		...
		try {
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			if (((((_la - 39)) & ~0x1F) === 0 && ((1 << (_la - 39)) & ((1 << (LGFileParser.STRUCTURED_NEWLINE - 39)) | (1 << (LGFileParser.STRUCTURE_IDENTIFIER - 39)) | (1 << (LGFileParser.STRUCTURE_EQUALS - 39)) | (1 << (LGFileParser.STRUCTURE_OR_MARK - 39)) | (1 << (LGFileParser.ESCAPE_CHARACTER_IN_STRUCTURE_BODY - 39)) | (1 << (LGFileParser.EXPRESSION_IN_STRUCTURE_BODY - 39)) | (1 << (LGFileParser.TEXT_IN_STRUCTURE_BODY - 39)))) !== 0)) {
				{
				this.state = 130;
				this._errHandler.sync(this);
				_la = this._input.LA(1);
				do {
					...
					case 1:
						...
						this._errHandler.sync(this);
						_la = this._input.LA(1);
						if (_la === LGFileParser.STRUCTURE_IDENTIFIER || _la === LGFileParser.EXPRESSION_IN_STRUCTURE_BODY) {
							{
							this.state = 125;
					...
					this._errHandler.sync(this);
					_la = this._input.LA(1);
				} while (((((_la - 39)) & ~0x1F) === 0 && ((1 << (_la - 39)) & ((1 << (LGFileParser.STRUCTURED_NEWLINE - 39)) | (1 << (LGFileParser.STRUCTURE_IDENTIFIER - 39)) | (1 << (LGFileParser.STRUCTURE_EQUALS - 39)) | (1 << (LGFileParser.STRUCTURE_OR_MARK - 39)) | (1 << (LGFileParser.ESCAPE_CHARACTER_IN_STRUCTURE_BODY - 39)) | (1 << (LGFileParser.EXPRESSION_IN_STRUCTURE_BODY - 39)) | (1 << (LGFileParser.TEXT_IN_STRUCTURE_BODY - 39)))) !== 0));
				}
			}
	...
	public structuredBodyContentLine(): StructuredBodyContentLineContext {
		...
		try {
			...
			this._errHandler.sync(this);
			switch (this._input.LA(1)) {
			case LGFileParser.STRUCTURE_IDENTIFIER:
				this.enterOuterAlt(_localctx, 1);
				{
				this.state = 150;
		...
		try {
			...
			do {
				...
				case 1:
					...
					this.state = 154;
					_la = this._input.LA(1);
					if (!(((((_la - 41)) & ~0x1F) === 0 && ((1 << (_la - 41)) & ((1 << (LGFileParser.STRUCTURE_IDENTIFIER - 41)) | (1 << (LGFileParser.STRUCTURE_EQUALS - 41)) | (1 << (LGFileParser.STRUCTURE_OR_MARK - 41)) | (1 << (LGFileParser.ESCAPE_CHARACTER_IN_STRUCTURE_BODY - 41)) | (1 << (LGFileParser.EXPRESSION_IN_STRUCTURE_BODY - 41)) | (1 << (LGFileParser.TEXT_IN_STRUCTURE_BODY - 41)))) !== 0))) {
					this._errHandler.recoverInline(this);
					} else {
						if (this._input.LA(1) === Token.EOF) {
							this.matchedEOF = true;
	...
	public keyValueStructureValue(): KeyValueStructureValueContext {
		...
		try {
			...
			do {
				...
				this.state = 169;
				_la = this._input.LA(1);
				if (!(((((_la - 44)) & ~0x1F) === 0 && ((1 << (_la - 44)) & ((1 << (LGFileParser.ESCAPE_CHARACTER_IN_STRUCTURE_BODY - 44)) | (1 << (LGFileParser.EXPRESSION_IN_STRUCTURE_BODY - 44)) | (1 << (LGFileParser.TEXT_IN_STRUCTURE_BODY - 44)))) !== 0))) {
				this._errHandler.recoverInline(this);
				} else {
					if (this._input.LA(1) === Token.EOF) {
						this.matchedEOF = true;
				...
				this._errHandler.sync(this);
				_la = this._input.LA(1);
			} while (((((_la - 44)) & ~0x1F) === 0 && ((1 << (_la - 44)) & ((1 << (LGFileParser.ESCAPE_CHARACTER_IN_STRUCTURE_BODY - 44)) | (1 << (LGFileParser.EXPRESSION_IN_STRUCTURE_BODY - 44)) | (1 << (LGFileParser.TEXT_IN_STRUCTURE_BODY - 44)))) !== 0));
			}
		}
		catch (re) {
			if (re instanceof RecognitionException) {
	...
	public static readonly _serializedATN: string =
		...
		"\x05\tu\n\t\x03\t\x03\t\x03\n\x03\n\x03\n\x03\n\x05\n}\n\n\x03\v\x03\v" +
		"\x05\v\x81\n\v\x03\v\x03\v\x06\v\x85\n\v\r\v\x0E\v\x86\x05\v\x89\n\v\x03" +
		"\v\x05\v\x8C\n\v\x03\f\x03\f\x03\f\x05\f\x91\n\f\x03\r\x07\r\x94\n\r\f" +
		"\r\x0E\r\x97\v\r\x03\x0E\x03\x0E\x05\x0E\x9B\n\x0E\x03\x0F\x06\x0F\x9E" +
		"\n\x0F\r\x0F\x0E\x0F\x9F\x03\x10\x03\x10\x03\x10\x03\x10\x03\x10\x07\x10" +
		"\xA7\n\x10\f\x10\x0E\x10\xAA\v\x10\x03\x11\x06\x11\xAD\n\x11\r\x11\x0E" +
		"\x11\xAE\x03\x12\x03\x12\x03\x13\x03\x13\x03\x14\x06\x14\xB6\n\x14\r\x14" +
		"\x0E\x14\xB7\x03\x15\x03\x15\x05\x15\xBC\n\x15\x03\x16\x03\x16\x05\x16" +
		"\xC0\n\x16\x03\x16\x07\x16\xC3\n\x16\f\x16\x0E\x16\xC6\v\x16\x03\x16\x05" +
		"\x16\xC9\n\x16\x03\x17\x06\x17\xCC\n\x17\r\x17\x0E\x17\xCD\x03\x18\x06" +
		"\x18\xD1\n\x18\r\x18\x0E\x18\xD2\x03\x19\x03\x19\x05\x19\xD7\n\x19\x03" +
		"\x1A\x03\x1A\x03\x1A\x07\x1A\xDC\n\x1A\f\x1A\x0E\x1A\xDF\v\x1A\x03\x1B" +
		"\x06\x1B\xE2\n\x1B\r\x1B\x0E\x1B\xE3\x03\x1C\x03\x1C\x05\x1C\xE8\n\x1C" +
		"\x03\x1D\x03\x1D\x03\x1D\x07\x1D\xED\n\x1D\f\x1D\x0E\x1D\xF0\v\x1D\x03" +
		"\x1E\x03\x1E\x03\x1F\x03\x1F\x03\x1F\x03A\x02\x02 \x02\x02\x04\x02\x06" +
		"\x02\b\x02\n\x02\f\x02\x0E\x02\x10\x02\x12\x02\x14\x02\x16\x02\x18\x02" +
		"\x1A\x02\x1C\x02\x1E\x02 \x02\"\x02$\x02&\x02(\x02*\x02,\x02.\x020\x02" +
		"2\x024\x026\x028\x02:\x02<\x02\x02\n\x03\x02\x10\x15\x03\x02%&\x03\x02" +
		"+0\x03\x02.0\x03\x02\x1F!\x03\x02\x19\x1B\x04\x02\x05\x05 !\x03\x02\x1C" +
		"\x1E\xFE\x02?\x03\x02\x02\x02\x04J\x03\x02\x02\x02\x06M\x03\x02\x02\x02" +
		"\bQ\x03\x02\x02\x02\nU\x03\x02\x02\x02\f`\x03\x02\x02\x02\x0Ec\x03\x02" +
		"\x02\x02\x10k\x03\x02\x02\x02\x12|\x03\x02\x02\x02\x14~\x03\x02\x02\x02" +
		"\x16\x8D\x03\x02\x02\x02\x18\x95\x03\x02\x02\x02\x1A\x9A\x03\x02\x02\x02" +
		"\x1C\x9D\x03\x02\x02\x02\x1E\xA1\x03\x02\x02\x02 \xAC\x03\x02\x02\x02" +
		"\"\xB0\x03\x02\x02\x02$\xB2\x03\x02\x02\x02&\xB5\x03\x02\x02\x02(\xBB" +
		"\x03\x02\x02\x02*\xBD\x03\x02\x02\x02,\xCB\x03\x02\x02\x02.\xD0\x03\x02" +
		"\x02\x020\xD4\x03\x02\x02\x022\xD8\x03\x02\x02\x024\xE1\x03\x02\x02\x02" +
		"6\xE5\x03\x02\x02\x028\xE9\x03\x02\x02\x02:\xF1\x03\x02\x02\x02<\xF3\x03" +
		"\x02\x02\x02>@\x05\x04\x03\x02?>\x03\x02\x02\x02@A\x03\x02\x02\x02AB\x03" +
		"\x02\x02\x02A?\x03\x02\x02\x02BC\x03\x02\x02\x02CD\x07\x02\x02\x03D\x03" +
		"\x03\x02\x02\x02EK\x05\b\x05\x02FK\x05:\x1E\x02GK\x05<\x1F\x02HK\x07\x02" +
		"\x02\x03IK\x05\x06\x04\x02JE\x03\x02\x02\x02JF\x03\x02\x02\x02JG\x03\x02" +
		"\x02\x02JH\x03\x02\x02\x02JI\x03\x02\x02\x02K\x05\x03\x02\x02\x02LN\x07" +
		"\r\x02\x02ML\x03\x02\x02\x02NO\x03\x02\x02\x02OM\x03\x02\x02\x02OP\x03" +
		"\x02\x02\x02P\x07\x03\x02\x02\x02QS\x05\n\x06\x02RT\x05\x12\n\x02SR\x03" +
		"\x02\x02\x02ST\x03\x02\x02\x02T\t\x03\x02\x02\x02U[\x07\x07\x02\x02VX" +
x02\x02\x02\x9E\x9F\x03\x02\x02\x02\x9F\x9D" +
		"\x03\x02\x02\x02\x9F\xA0\x03\x02\x02\x02\xA0\x1D\x03\x02\x02\x02\xA1\xA2" +
		"\x07+\x02\x02\xA2\xA3\x07,\x02\x02\xA3\xA8\x05 \x11\x02\xA4\xA5\x07-\x02" +
		"\x02\xA5\xA7\x05 \x11\x02\xA6\xA4\x03\x02\x02\x02\xA7\xAA\x03\x02\x02" +
		"\x02\xA8\xA6\x03\x02\x02\x02\xA8\xA9\x03\x02\x02\x02\xA9\x1F\x03\x02\x02" +
		"\x02\xAA\xA8\x03\x02\x02\x02\xAB\xAD\t\x05\x02\x02\xAC\xAB\x03\x02\x02" +
		...
		"\xB3\x07*\x02\x02\xB3%\x03\x02\x02\x02\xB4\xB6\x05(\x15\x02\xB5\xB4\x03" +
		"\x02\x02\x02\xB6\xB7\x03\x02\x02\x02\xB7\xB5\x03\x02\x02\x02\xB7\xB8\x03" +
		"\x02\x02\x02\xB8\'\x03\x02\x02\x02\xB9\xBC\x05*\x16\x02\xBA\xBC\x05,\x17" +
		"\x02\xBB\xB9\x03\x02\x02\x02\xBB\xBA\x03\x02\x02\x02\xBC)\x03\x02\x02" +
		"\x02\xBD\xBF\x07\b\x02\x02\xBE\xC0\x07\x17\x02\x02\xBF\xBE\x03\x02\x02" +
		"\x02\xBF\xC0\x03\x02\x02\x02\xC0\xC4\x03\x02\x02\x02\xC1\xC3\t\x06\x02" +
		...
		"\x02\xC7\xC9\x07\"\x02\x02\xC8\xC7\x03\x02\x02\x02\xC8\xC9\x03\x02\x02" +
		"\x02\xC9+\x03\x02\x02\x02\xCA\xCC\x07\r\x02\x02\xCB\xCA\x03\x02\x02\x02" +
		"\xCC\xCD\x03\x02\x02\x02\xCD\xCB\x03\x02\x02\x02\xCD\xCE\x03\x02\x02\x02" +
		"\xCE-\x03\x02\x02\x02\xCF\xD1\x050\x19\x02\xD0\xCF\x03\x02\x02\x02\xD1" +
		"\xD2\x03\x02\x02\x02\xD2\xD0\x03\x02\x02\x02\xD2\xD3\x03\x02\x02\x02\xD3" +
		"/\x03\x02\x02\x02\xD4\xD6\x052\x1A\x02\xD5\xD7\x05&\x14\x02\xD6\xD5\x03" +
		"\x02\x02\x02\xD6\xD7\x03\x02\x02\x02\xD71\x03\x02\x02\x02\xD8\xD9\x07" +
		"\b\x02\x02\xD9\xDD\t\x07\x02\x02\xDA\xDC\t\b\x02\x02\xDB\xDA\x03\x02\x02" +
		"\x02\xDC\xDF\x03\x02\x02\x02\xDD\xDB\x03\x02\x02\x02\xDD\xDE\x03\x02\x02" +
		"\x02\xDE3\x03\x02\x02\x02\xDF\xDD\x03\x02\x02\x02\xE0\xE2\x056\x1C\x02" +
		"\xE1\xE0\x03\x02\x02\x02\xE2\xE3\x03\x02\x02\x02\xE3\xE1\x03\x02\x02\x02" +
		"\xE3\xE4\x03\x02\x02\x02\xE45\x03\x02\x02\x02\xE5\xE7\x058\x1D\x02\xE6" +
		"\xE8\x05&\x14\x02\xE7\xE6\x03\x02\x02\x02\xE7\xE8\x03\x02\x02\x02\xE8" +
		"7\x03\x02\x02\x02\xE9\xEA\x07\b\x02\x02\xEA\xEE\t\t\x02\x02\xEB\xED\t" +
		"\b\x02\x02\xEC\xEB\x03\x02\x02\x02\xED\xF0\x03\x02\x02\x02\xEE\xEC\x03" +
		"\x02\x02\x02\xEE\xEF\x03\x02\x02\x02\xEF9\x03\x02\x02\x02\xF0\xEE\x03" +
		"\x02\x02\x02\xF1\xF2\x07\f\x02\x02\xF2;\x03\x02\x02\x02\xF3\xF4\x07\x03" +
		"\x02\x02\xF4=\x03\x02\x02\x02$AJOSX[`hqt|\x80\x84\x86\x88\x8B\x90\x95" +
		"\x9A\x9F\xA8\xAE\xB7\xBB\xBF\xC4\xC8\xCD\xD2\xD6\xDD\xE3\xE7\xEE";
