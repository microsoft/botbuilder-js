...
/**
 *  This customized memory scope is designed for allow sub template evaluation can refer
 *  to the original evaluation scope passed in by wrap the original one in globalScope field
