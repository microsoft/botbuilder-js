 ...
 * ```
 */
export declare class RegExpRecognizer extends IntentRecognizer<RegExpEntities> {
    private settings;
    private intents;
    /**
     ...
     */
    static recognize(text: string, expression: RegExp, groupNames?: string[], minScore?: number): Intent<RegExpEntities> | undefined;
}
