...
import { Dialog, DialogContext, DialogReason, DialogTurnResult } from 'botbuilder-dialogs';
import { DialogFlowContext, DialogFlowTask } from './';
import { DialogFlowDispatcher, FluentDialogState } from './dialogFlowDispatcher';
...
export class FluentDialog<O extends object = {}, T = any> extends Dialog<O> {
     ...
     * @inheritdoc
     */
    override beginDialog(dc: DialogContext, options?: O): Promise<DialogTurnResult> {
     ...
     * @inheritdoc
     */
    override continueDialog(dc: DialogContext): Promise<DialogTurnResult> {
     ...
     * @inheritdoc
     */
    override resumeDialog(dc: DialogContext, reason: DialogReason, result?: any): Promise<DialogTurnResult> {
