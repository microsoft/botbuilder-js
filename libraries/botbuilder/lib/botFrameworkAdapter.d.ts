...
import { BotAdapter, Promiseable, TurnContext, Activity, ConversationReference, ResourceResponse, TokenResponse, ConversationsResult, ChannelAccount } from 'botbuilder-core';
/**
