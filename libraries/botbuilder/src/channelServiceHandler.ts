...
export class ChannelServiceHandler {
     ...
     */
    protected async onGetConversationPagedMembers(claimsIdentity: ClaimsIdentity, conversationId: string, pageSize = -1, continuationToken?: string): Promise<PagedMembersResult> {
