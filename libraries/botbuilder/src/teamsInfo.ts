...
export class TeamsInfo {
     ...
     * [MeetingNotificationRecipientFailureInfos](xref:botframework-schema.MeetingNotificationRecipientFailureInfos) if notifications
    ...
    static async sendMeetingNotification(
        ...
        meetingId?: string
    ): Promise<MeetingNotificationRecipientFailureInfos | {}> {
        const activity = context.activity;
