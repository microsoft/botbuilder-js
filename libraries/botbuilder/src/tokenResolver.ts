...
import { BotFrameworkAdapter } from '.';
import { TurnContext, Activity, BotCallbackHandlerKey, CardFactory, OAuthLoginTimeoutMsValue, TokenPollingSettingsKey, TokenResponse, ActivityTypes, TokenPollingSettings } from 'botbuilder-core';
import { OAuthCard, ConversationReference, IEventActivity } from 'botframework-schema';
