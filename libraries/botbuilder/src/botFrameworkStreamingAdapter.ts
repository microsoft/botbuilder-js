...
import { ISocket, IStreamingTransportServer, IReceiveRequest, NamedPipeServer, NodeWebSocket,
     RequestHandler, StreamingResponse, WebSocketServer, StreamingRequest } from 'botframework-streaming';
...
import { BotFrameworkAdapter, BotFrameworkAdapterSettings, InvokeResponse, WebRequest } from '.';
