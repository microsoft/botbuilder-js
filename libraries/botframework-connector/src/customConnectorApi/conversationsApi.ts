...
export class ConversationsApi {
     ...
     */
    public async CreateConversation (parameters: Models.ConversationParameters, 
                                     options: Models.ConversationsApiCreateConversationOptionalParams = {headers: {}}) 
                                     : Promise<Models.ConversationsApiCreateConversationResponse> {
    ...
    public async DeleteConversationMember (conversationId: string, 
        memberId: string, 
        options: Models.ConversationsApiDeleteConversationMemberOptionalParams = {headers: {}}) 
        : Promise<Models.ConversationsApiDeleteConversationMemberResponse> {
    ...
    public async GetActivityMembers (conversationId: string, 
                                     activityId: string, 
                                     options: Models.ConversationsApiGetActivityMembersMemberOptionalParams = {headers: {}}) 
                                    : Promise<Models.ConversationsApiGetActivityMembersResponse> {
     ...
     * This REST API takes a ConversationId and returns an array 
     * of ChannelAccount objects representing the members of the conversation.
     ...
     * Each ConversationMembers object contains the ID of the conversation and an array 
     * of ChannelAccounts that describe the members of the conversation.
     * @summary GetConversations
     * @param continuationToken skip or continuation token
     */
    public async GetConversations (continuationToken?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ConversationsResult;  }> {
        const localVarPath = this.basePath + '/v3/conversations';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
     ...
     * if the channel supports it. If the channel does not support nested replies, 
