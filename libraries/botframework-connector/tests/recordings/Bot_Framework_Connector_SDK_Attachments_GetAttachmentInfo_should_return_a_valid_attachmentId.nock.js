...
nock('https://slack.botframework.com:443', {"encodedQueryParams":true})
  ...
  'Microsoft-IIS/10.0',
  'x-ms-request-id',
  '|048d82cdbca15c49be5318f5355337b9.1e8cf241_',
  'Strict-Transport-Security',
  'max-age=31536000',
  'Date',
  'Fri, 14 Jun 2019 23:19:54 GMT',
  'Connection',
  'close' ]);
 return result; },
function (nock) { 
...
nock('https://slack.botframework.com:443', {"encodedQueryParams":true})
  ...
  .reply(200, {"id":"at26640-JF9W5DZ8cYA-e"}, [ 'Cache-Control',
  'no-cache',
  'Pragma',
  'no-cache',
  'Content-Length',
  ...
  'Microsoft-IIS/10.0',
  'x-ms-request-id',
  '|6b119a96de52f64ebc9a494612dfd10f.3d8f46ba_3d8f46bb_',
  'Strict-Transport-Security',
  'max-age=31536000',
  'Date',
  'Fri, 14 Jun 2019 23:19:54 GMT',
...
var result = 
nock('https://slack.botframework.com:443', {"encodedQueryParams":true})
  .get('/v3/attachments/at26640-JF9W5DZ8cYA-e')
  ...
  'Microsoft-IIS/10.0',
  'x-ms-request-id',
  '|665300344cc03b4893e9caf0bbea79af.1e8cf242_',
  'Strict-Transport-Security',
  'max-age=31536000',
  'Date',
  'Fri, 14 Jun 2019 23:19:55 GMT',
  'Connection',
  'close' ]);
 return result; }]];