...
nock('https://slack.botframework.com:443', {"encodedQueryParams":true})
  ...
  'Microsoft-IIS/10.0',
  'x-ms-request-id',
  '|d63b1584612c904a80a62b3e78ee817c.3d90786a_',
  'Strict-Transport-Security',
  'max-age=31536000',
  'Date',
  'Mon, 17 Jun 2019 16:09:19 GMT',
  'Connection',
  'close' ]);
 return result; },
function (nock) { 
...
nock('https://slack.botframework.com:443', {"encodedQueryParams":true})
  ...
  'Microsoft-IIS/10.0',
  'x-ms-request-id',
  '|e49b56a3f3c7504e8341cc59d693406c.1e8e23fe_1e8e23ff_',
  'Strict-Transport-Security',
  'max-age=31536000',
  'Date',
  'Mon, 17 Jun 2019 16:09:19 GMT',
...
var result = 
nock('https://slack.botframework.com:443', {"encodedQueryParams":true})
  .get('/v3/attachments/at26705-1n1ymt6srMO-e')
  ...
  'Microsoft-IIS/10.0',
  'x-ms-request-id',
  '|6731aea48be698488085a20b65f19a78.1e8e2400_',
  'Strict-Transport-Security',
  'max-age=31536000',
  'Date',
  'Mon, 17 Jun 2019 16:09:20 GMT',
  'Connection',
  'close' ]);
 return result; },
function (nock) { 
var result = 
nock('https://slack.botframework.com:443', {"encodedQueryParams":true})
  .get('/v3/attachments/at26705-1n1ymt6srMO-e/views/original')
  .reply(200, () => {
  ...
  'Microsoft-IIS/10.0',
  'x-ms-request-id',
  '|3e56d12ff967c2409f959700712e75e7.3d90786d_',
  'Content-Disposition',
