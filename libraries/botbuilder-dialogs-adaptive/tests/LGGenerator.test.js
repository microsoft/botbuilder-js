    ...
    describe('TestMultiLangImport', () => {
        ...
        describe('TestLGResourceGroup', async function() {
            it('assert empty locale', async () => {
                ...
                assert.equal(new Set(resourceNames), new Set(['a.lg', 'b.lg', 'c.lg', 'NormalStructureLG.lg','root.lg', 'subDialog.lg', 'test.lg']));
            });
            ...
            it('assert en-us locale', async () => {
                ...
                assert.equal(resourceNames.length, 7);
                assert.equal(new Set(resourceNames), new Set(['a.en-US.lg', 'b.en-us.lg', 'test.en-US.lg', 'c.en.lg', 'NormalStructureLG.lg','root.lg', 'subDialog.lg']));
            });
            ...
            it('assert en locale', async () => {
                ...
                assert.equal(resourceNames.length, 7);
                assert.equal(new Set(resourceNames), new Set(['c.en.lg', 'test.en.lg', 'a.en.lg', 'b.lg', 'NormalStructureLG.lg','root.lg', 'subDialog.lg']));
            });
        });
