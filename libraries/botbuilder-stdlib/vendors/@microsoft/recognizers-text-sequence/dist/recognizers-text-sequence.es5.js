...
(function (BasePhoneNumbers) {
    ...
    BasePhoneNumbers.TypicalDeductionRegexList = ['^\\d{3}-\\d{2}-\\d{4}$', '^\\d{5}-\\d{4}$'];
...
class BasePhoneNumberExtractor extends BaseSequenceExtractor {
    constructor() {
        ...
        this.regexes = new Map()
            .set(recognizersText.RegExpUtility.getSafeRegExp(basePhoneNumbers.BasePhoneNumbers.BRPhoneNumberRegex), constants.Constants.PHONE_NUMBER_REGEX_BR)
            ...
            .set(recognizersText.RegExpUtility.getSafeRegExp(basePhoneNumbers.BasePhoneNumbers.DEPhoneNumberRegex), constants.Constants.PHONE_NUMBER_REGEX_DE)
            ...
            .set(recognizersText.RegExpUtility.getSafeRegExp(basePhoneNumbers.BasePhoneNumbers.CNPhoneNumberRegex), constants.Constants.PHONE_NUMBER_REGEX_CN)
            .set(recognizersText.RegExpUtility.getSafeRegExp(basePhoneNumbers.BasePhoneNumbers.DKPhoneNumberRegex), constants.Constants.PHONE_NUMBER_REGEX_DK)
            .set(recognizersText.RegExpUtility.getSafeRegExp(basePhoneNumbers.BasePhoneNumbers.ITPhoneNumberRegex), constants.Constants.PHONE_NUMBER_REGEX_IT)
            .set(recognizersText.RegExpUtility.getSafeRegExp(basePhoneNumbers.BasePhoneNumbers.NLPhoneNumberRegex), constants.Constants.PHONE_NUMBER_REGEX_NL)
            .set(recognizersText.RegExpUtility.getSafeRegExp(basePhoneNumbers.BasePhoneNumbers.SpecialPhoneNumberRegex), constants.Constants.PHONE_NUMBER_REGEX_SPECIAL);
    }
    extract(source) {
        ...
        for (let er of ers) {
            ...
            if (er.start === 0 || basePhoneNumbers.BasePhoneNumbers.SeparatorCharList.indexOf(ch) === -1) {
                ret.push(er);
            }
        }
        return ret;
...
class BaseURLExtractor extends BaseSequenceExtractor {
    constructor() {
        super();
        this.regexes = new Map()
            .set(recognizersText.RegExpUtility.getSafeRegExp(baseURL.BaseURL.UrlRegex), constants.Constants.URL_REGEX)
            .set(recognizersText.RegExpUtility.getSafeRegExp(baseURL.BaseURL.UrlRegex2), constants.Constants.URL_REGEX)
            .set(recognizersText.RegExpUtility.getSafeRegExp(baseURL.BaseURL.IpUrlRegex), constants.Constants.URL_REGEX);
    }
}
...
class PhoneNumberExtractor extends extractors$4.BasePhoneNumberExtractor {
    extract(source) {
        ...
        var maskRegex = new RegExp(basePhoneNumbers.BasePhoneNumbers.PhoneNumberMaskRegex, "g");
        var m;
...
class SequenceRecognizer extends recognizersText.Recognizer {
    ...
    InitializeConfiguration() {
        this.registerModel("PhoneNumberModel", recognizersText.Culture.English, (options) => new models$2.PhoneNumberModel(new parsers$2.PhoneNumberParser(), new extractors$2.PhoneNumberExtractor()));
        this.registerModel("IpAddressModel", recognizersText.Culture.English, (options) => new models$2.IpAddressModel(new parsers$2.IpParser(), new extractors$2.IpExtractor()));
        ...
        this.registerModel("URLModel", recognizersText.Culture.English, (options) => new models$2.URLModel(new parsers$2.URLParser(), new extractors$2.URLExtractor()));
