...
class ChoiceRecognizer extends recognizersText.Recognizer {
    ...
    InitializeConfiguration() {
        ...
        //#endregion
        //#region Japanese
        this.registerModel("BooleanModel", recognizersText.Culture.Japanese, (options) => new models$2.BooleanModel(new parsers$2.BooleanParser(), new extractors$2.BooleanExtractor(new boolean_1$3.JapaneseBooleanExtractorConfiguration())));
        //#endregion
        //#region Portuguese
        this.registerModel("BooleanModel", recognizersText.Culture.Portuguese, (options) => new models$2.BooleanModel(new parsers$2.BooleanParser(), new extractors$2.BooleanExtractor(new boolean_1$4.PortugueseBooleanExtractorConfiguration())));
        //#endregion
        //#region Spanish
        this.registerModel("BooleanModel", recognizersText.Culture.Spanish, (options) => new models$2.BooleanModel(new parsers$2.BooleanParser(), new extractors$2.BooleanExtractor(new boolean_1$5.SpanishBooleanExtractorConfiguration())));
        //#endregion
        //#region Chinese
        this.registerModel("BooleanModel", recognizersText.Culture.Chinese, (options) => new models$2.BooleanModel(new parsers$2.BooleanParser(), new extractors$2.BooleanExtractor(new boolean_1$6.ChineseBooleanExtractorConfiguration())));
        //#endregion
        //#region French
        this.registerModel("BooleanModel", recognizersText.Culture.French, (options) => new models$2.BooleanModel(new parsers$2.BooleanParser(), new extractors$2.BooleanExtractor(new boolean_1$1.FrenchBooleanExtractorConfiguration())));
        //#endregion
        //#region German
        this.registerModel("BooleanModel", recognizersText.Culture.German, (options) => new models$2.BooleanModel(new parsers$2.BooleanParser(), new extractors$2.BooleanExtractor(new boolean_1$2.GermanBooleanExtractorConfiguration())));
        //#endregion
    }
...
exports.FrenchBooleanExtractorConfiguration = boolean_1$1.FrenchBooleanExtractorConfiguration;

exports.GermanBooleanExtractorConfiguration = boolean_1$2.GermanBooleanExtractorConfiguration;

exports.PortugueseBooleanExtractorConfiguration = boolean_1$4.PortugueseBooleanExtractorConfiguration;

exports.JapaneseBooleanExtractorConfiguration = boolean_1$3.JapaneseBooleanExtractorConfiguration;

exports.SpanishBooleanExtractorConfiguration = boolean_1$5.SpanishBooleanExtractorConfiguration;

exports.ChineseBooleanExtractorConfiguration = boolean_1$6.ChineseBooleanExtractorConfiguration;
...
var recognizersTextChoice_13 = recognizersTextChoice.FrenchBooleanExtractorConfiguration;
var recognizersTextChoice_14 = recognizersTextChoice.GermanBooleanExtractorConfiguration;
var recognizersTextChoice_15 = recognizersTextChoice.PortugueseBooleanExtractorConfiguration;
var recognizersTextChoice_16 = recognizersTextChoice.JapaneseBooleanExtractorConfiguration;
var recognizersTextChoice_17 = recognizersTextChoice.SpanishBooleanExtractorConfiguration;
var recognizersTextChoice_18 = recognizersTextChoice.ChineseBooleanExtractorConfiguration;
