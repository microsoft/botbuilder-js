...
// Language generation template references
...
class BasicBot {
     ...
     */
    constructor(conversationState, userState, lgEntitiesState, botConfig) {
        ...
        this.dialogs.add(new GreetingDialog(GREETING_DIALOG, this.userProfileAccessor, lgEntitiesState));
    ...
    async isTurnInterrupted(dc, luisResults) {
        ...
        if (topIntent === HELP_INTENT) {
            await dc.context.sendActivity(templateReferences.offerHelp);
