...
describe('LuisRecognizer', function () {
    ...
    it('should return multiple intents and prebuilt entities with a single value', function(done){
        ...
        recognizer.recognize(context).then(res => {
                ...
                assert(res[0].$instance);
                assert(res[0].$instance.entities);
                assert(res[0].$instance.entities.builtin_number);
                assert(res[0].$instance.entities.builtin_number[0].$startIndex === 28);
                assert(res[0].$instance.entities.builtin_number[0].$endIndex === 31);
                assert(res[0].$instance.entities.builtin_number[0].$text);
                assert(res[0].$instance.entities.builtin_number[0].$text === '2001');
                assert(res[0].$instance.entities.builtin_datetimeV2_date);
                assert(res[0].$instance.entities.builtin_datetimeV2_date[0].$startIndex === 15);
                assert(res[0].$instance.entities.builtin_datetimeV2_date[0].$endIndex === 31);
                assert(res[0].$instance.entities.builtin_datetimeV2_date[0].$text);
                assert(res[0].$instance.entities.builtin_datetimeV2_date[0].$text === 'february 2nd 2001');
                done();
            });
    });
    ...
    it('should return multiple intents and a list entity with a single value', function(done){
        ...
        recognizer.recognize(context).then(res => {
                ...
                assert(res[0].$instance.entities.Airline[0].$text);
                assert(res[0].$instance.entities.Airline[0].$text === 'united');
                done();
            });
    });
    ...
    it('should return multiple intents and a list entity with multiple values', function(done){
        ...
        recognizer.recognize(context).then(res => {
                ...
                assert(res[0].$instance.entities.Airline[0].$text);
                assert(res[0].$instance.entities.Airline[0].$text === 'dl');
                done();
            });
    });
    ...
    it('should return multiple intents and a single composite entity', function(done){
        ...
        recognizer.recognize(context).then(res => {
                ...
                assert(res[0].$instance);
                assert(res[0].$instance.entities);
                assert(res[0].$instance.entities.builtin_number === undefined);
                ...
                assert(res[0].$instance.entities.Address[0].builtin_number);
                assert(res[0].$instance.entities.Address[0].builtin_number[0].$startIndex);
                assert(res[0].$instance.entities.Address[0].builtin_number[0].$startIndex === 21);
                assert(res[0].$instance.entities.Address[0].builtin_number[0].$endIndex);
                assert(res[0].$instance.entities.Address[0].builtin_number[0].$endIndex === 25);
                assert(res[0].$instance.entities.Address[0].builtin_number[0].$text);
                assert(res[0].$instance.entities.Address[0].builtin_number[0].$text === "98033");
