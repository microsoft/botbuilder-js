...
describe('QnAMaker', function () {
    ...
    describe('Active Learning', function() {
        it('executeHttpRequest() should return JSON result from Train API response of 204 No-Content', function() {
        ...
        it('callTrainAsync() should send correct payload body to Train API and return result', function() {
            ...
            async () => await callTrainTest();
        
            async function callTrainTest() {const testKbId = 'testKbId';
                nock(endpoint.qnaHost)
                    .post(trainApi)
                    .reply(204);
...
class TrainApiHelper
{
    constructor() {
        ...
        this.trainApi = `/knowledgebases/${ testKbId }/train`;
        this.feedbackRecords = [{userId: "user1", userQuestion: "wi-fi", qnaId: "17"}];

        this.successfullyTrainedResult = { 
            questions: [],
