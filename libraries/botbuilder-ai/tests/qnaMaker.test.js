...
//     });
    ...
    describe('Active Learning', function() {
        it('should return a QnAMakerResult from Train API response of 204 No-Content', function() {
            async () => await callTrainApiTest();
        
            async function callTrainApiTest() {const testKbId = 'testKbId';
                ...
                const payloadBody = JSON.stringify({
                    feedbackRecords: [{userId: "user1", userQuestion: "wi-fi", qnaId: "17"}]
                });

                const expectedQnaResult = { 
                    questions: [],
                ...
                try {
                    ...
                    assert.deepStrictEqual(qnaResult, expectedQnaResult);

                    // const trainUtils = new 
                } catch (error) {
                    throw error;
                }
            };
        ...
        it('should send correct payload body to Train API and return result', function() {
            async () => await callTrainApiTest();
            ...
            async function callTrainApiTest() {const testKbId = 'testKbId';
                ...
                try {
                    ...
                    const qnaResult = await trainUtils.callTrainAsync(feedbackRecords);
