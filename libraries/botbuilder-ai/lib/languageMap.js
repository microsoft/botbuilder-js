...
exports.codesToNames = {};
exports.namesToCode = {};
exports.namesToNames = {};
AddLanguageMap("ar", "Arabic");
AddLanguageMap("bs-Latn", "Bosnian");
AddLanguageMap("bg", "Bulgarian");
AddLanguageMap("ca", "Catalan");
AddLanguageMap("zh-CHS", "Chinese Simplified");
AddLanguageMap("zh-CHT", "Chinese Traditional");
exports.namesToNames["Chinese"] = ["Simplified", "Traditional"];
AddLanguageMap("hr", "Croatian");
AddLanguageMap("cs", "Czech");
AddLanguageMap("da", "Danish");
AddLanguageMap("nl", "Dutch");
AddLanguageMap("en", "English");
AddLanguageMap("et", "Estonian");
AddLanguageMap("fi", "Finnish");
AddLanguageMap("fr", "French");
AddLanguageMap("de", "German");
AddLanguageMap("el", "Greek");
AddLanguageMap("ht", "Haitian Creole");
exports.namesToCode["creole"] = "ht";
AddLanguageMap("he", "Hebrew");
AddLanguageMap("hi", "Hindi");
AddLanguageMap("mww", "Hmong Daw");
exports.namesToCode["hmong"] = "mww";
exports.namesToCode["daw"] = "mww";
AddLanguageMap("hu", "Hungarian");
AddLanguageMap("id", "Indonesian");
AddLanguageMap("it", "Italian");
AddLanguageMap("ja", "Japanese");
AddLanguageMap("sw", "Kiswahili");
AddLanguageMap("ko", "Korean");
AddLanguageMap("tlh", "Klingon");
AddLanguageMap("lv", "Latvian");
AddLanguageMap("lt", "Lithuanian");
AddLanguageMap("ms", "Malay");
AddLanguageMap("mt", "Maltese");
AddLanguageMap("no", "Norwegian");
AddLanguageMap("fa", "Persian");
AddLanguageMap("pl", "Polish");
AddLanguageMap("pt", "Portuguese");
AddLanguageMap("otq", "Querétaro Otomi");
exports.namesToCode["querétaro"] = "otq";
exports.namesToCode["otomi"] = "otq";
AddLanguageMap("ro", "Romanian");
AddLanguageMap("ru", "Russian");
AddLanguageMap("sr-Cyrl", "Serbian Cyrillic");
AddLanguageMap("sr-Latn", "Serbian Latin");
exports.namesToNames["Serbian"] = ["Cyrillic", "Latin"];
AddLanguageMap("sk", "Slovak");
AddLanguageMap("sl", "Slovenian");
AddLanguageMap("es", "Spanish");
AddLanguageMap("sv", "Swedish");
AddLanguageMap("th", "Thai");
AddLanguageMap("tr", "Turkish");
AddLanguageMap("uk", "Ukrainian");
AddLanguageMap("ur", "Urdu");
AddLanguageMap("vi", "Vietnamese");
AddLanguageMap("cy", "Welsh");
AddLanguageMap("yua", "Yucatec Maya");
exports.namesToCode["yucatec"] = "yua";
exports.namesToCode["maya"] = "yua";
function AddLanguageMap(code, name) {
    exports.codesToNames[code] = name.toLowerCase();
    exports.namesToCode[name.toLowerCase()] = code;
}
function GetCodeForInput(values) {
    let code;
    for (let iValue in values) {
        let value = values[iValue];
        if (exports.namesToCode[value])
            return exports.namesToCode[value];
        // if (namesToNames[value]) {
        //     for (let iName in namesToNames[value]) {
        //         let name = namesToNames[iName];
        ...
        //         }
        //     }
        //     if (TryCompound(value, namesToNames[value].FirstOrDefault(), out code))
        //         return code;
        // }
        // if (namesToCodes.Values.Contains(value))
        //     return value;
    }
    return 'en';
}
function GetCodeOrFallback(code) {
    if (!code || code.length == 0)
        return "en";
    code = code.trim();
    if (exports.codesToNames[code])
        return code;
    return "en";
}
