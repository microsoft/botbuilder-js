...
server.listen(process.env.port || process.env.PORT || 3978, function() {
    ...
    console.log(`\nTo talk to your bot, open the cafe-bot.bot file in the Emulator`);
});
...
let botConfig;
try {
    botConfig = BotConfiguration.loadSync(path.join(__dirname, './cafe-bot.bot'), process.env.botFileSecret);
} catch (err) {
