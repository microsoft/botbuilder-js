 ...
 */
function _resolve2(appId, query, options, callback) {
...
class Prediction {
   ...
   */
  resolve2WithHttpOperationResponse(appId, query, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._resolve2(appId, query, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  resolve2(appId, query, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._resolve2(appId, query, options, optionalCallback);
    }
  }
