...
import { MessagingExtensionActionResponse, TaskModuleContinueResponse, TaskModuleTaskInfo } from 'botbuilder';
import {
    Converter,
    ConverterFactory,
    DialogConfiguration,
...
export interface SendMessagingExtensionActionResponseConfiguration extends DialogConfiguration {
    ...
    card?: TemplateInterface<string, DialogStateManager>;
}
...
export class SendMessagingExtensionActionResponse
     ...
     */
    public card: TemplateInterface<string, DialogStateManager>;
