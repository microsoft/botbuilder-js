...
describe('expressionProperty tests', async function() {
    it('ArrayExpression string', async function () {
        class ArrFoo {
    ...
    it('ArrayExpression object', async function () {
        class Foo {
            public age: number;
            public name: string;
        }
    ...
    it('BoolExpression', async function () {
    ...
    it('EnumExpression', async function () {
        enum TestEnum {
            One,
            Two,
            Three,
    ...
    it('NumberExpression', async function() {
    ...
    it('ObjectExpression', async function() {
        class Foo {
            public age: number;
            public name: string;
        }
    ...
    it('StringExpression', async function() {
        const data = { test: 'joe' };

        let str = new StringExpression('test');
        let result = await str.getValue(data);
        assert.strictEqual(result, 'test');

        str = new StringExpression('=test');
        result = await str.getValue(data);
    ...
    it('ValueExpression', async function() {
