...
export class MultivariateNumericEvaluator extends ExpressionEvaluator {
     ...
     */
    public constructor(type: string, func: (args: readonly number[]) => number, verify?: VerifyExpression) {
        super(
            type,
     ...
     * @private
     */
    private static evaluator(func: (args: readonly number[]) => number, verify?: VerifyExpression): EvaluateExpressionDelegate {
