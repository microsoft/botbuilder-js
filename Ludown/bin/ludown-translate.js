...
program
    ...
    .description(`Translate .lu files from one language to another`)
    .usage('-k <translate_key> --in <luFile> | -k <translate_key> --lu_folder <inputFolder> [-s]')
    .option('--in <luFile>', '.lu file to parse')
    .option('-t, --to_lang', 'Target language to translate to. See https://aka.ms/translate-langs for list of supported langauges and codes.')
    .option('-k, --translate_key', 'Your translation key. See https://aka.ms/translate-key to get your key')
    ...
    .option('-b, --translate_label_values', '[Optional] Translate labelled values in utterances')
